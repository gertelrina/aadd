...
class FlacMelMultilabelAugDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # is_all_zeros = torch.all(label == 0)
...
main_path_audio = '/home/user/agertel/dipl/data/augmented/train_multilabel_imgs_all_total/'
main_path_csv = '/home/user/agertel/dipl/data/augmented/train_multilabel_labels_all/'
...
main_path_audio = '/home/user/agertel/dipl/data/augmented/val_multilabel_imgs_all_total/'
main_path_csv = '/home/user/agertel/dipl/data/augmented/val_multilabel_labels_all/'
...
wandb.init(project="audio-degr-detection",
           ...
           tags=["separate_imgs"],
           name="bceloss_total_dataset_fullimg")
